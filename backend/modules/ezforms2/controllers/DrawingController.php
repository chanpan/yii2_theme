...
class DrawingController extends Controller {
    ...
    public function actionCanvasImage() {
        if (Yii::$app->getRequest()->isAjax) {
            ...
            $fullPath = Yii::getAlias('@storage/ezform/print/') . $nowFileName;            
    ...
    public function actionSaveImage() {
        if (Yii::$app->getRequest()->isAjax) {
            ...
            //date("YmdHis")
            $nowFileName = $idName . '_' . $_POST['name'] . '_tmp.png';
            $fullPath = Yii::getAlias('@storage/ezform/drawing/') . $nowFileName;            
    ...
    public function actionBgImage() {
        if (Yii::$app->getRequest()->isAjax) {
            ...
            if (isset($_GET['oldfile'])) {
                unlink(Yii::getAlias('@storage/ezform/drawing/') . $_GET['oldfile']);
            }
