...
class EzformFieldsSearch extends EzformFields {
    ...
    public function rules() {
        return [
            ...
            [['table_index', 'ref_field_id', 'ezf_field_name', 'ezf_field_label', 'ezf_field_default', 'ref_field_desc', 'ref_field_search', 'ezf_field_hint', 'ezf_field_validate', 'ezf_field_data', 'ezf_field_specific', 'ezf_field_options', 'table_field_type', 'ezf_field_color', 'ezf_field_cal', 'created_at', 'updated_at'], 'safe'],
