...
class EzformFields extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            ['ezf_field_name', 'match', 'pattern' => '/^[a-z0-9_]+$/i', 'message' => Yii::t('ezform', 'Variables must be in English or numbers only and do not contain spaces.')],
            ...
            [['ref_field_desc', 'ref_field_search', 'ezf_field_hint', 'ezf_field_validate', 'ezf_field_data', 'ezf_field_specific', 'ezf_field_options', 'ezf_field_cal'], 'string'],
            [['ezf_field_order'], 'number'],
            [['ref_field_id', 'table_field_length', 'table_field_type', 'ezf_condition', 'ezf_target', 'table_index', 'ezf_special', 'created_at', 'updated_at'], 'safe'],
    ...
    public function attributeLabels() {
        return [
            ...
            'ezf_field_label' => Yii::t('ezform', 'Label'),
            ...
            'ezf_field_lenght' => Yii::t('ezform', 'Lenght'),
            ...
            'table_index'=> Yii::t('ezform', 'Index'),
        ];
    }
