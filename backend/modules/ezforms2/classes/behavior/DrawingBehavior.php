                ...
                if($event->name == ActiveRecord::EVENT_AFTER_DELETE){
                    if($value!='' && stristr($value, '.png') == TRUE){
                        ...
                        if (stristr($fileName, '.png') == TRUE) {
                            @unlink(Yii::getAlias('@storage/ezform/drawing/data/') . $fileName);
                        }
                        
                        if (stristr($fileBg, '.png') == TRUE) {
                            @unlink(Yii::getAlias('@storage/ezform/drawing/bg/') . $fileBg);
                        }
                    }
                } else {
                    if($value!='' && stristr($value, 'tmp.png') == TRUE){
                        ...
                        if (stristr($fileName, 'tmp.png') == TRUE) {
                            ...
                            @copy(Yii::getAlias('@storage/ezform/drawing/') . $fileName, Yii::getAlias('@storage/ezform/drawing/data/') . $newFileName);
                            @unlink(Yii::getAlias('@storage/ezform/drawing/') . $fileName);
                        ...
                        if (stristr($fileBg, 'tmp.png') == TRUE) {
                            ...
                            @copy(Yii::getAlias('@storage/ezform/drawing/') . $fileBg, Yii::getAlias('@storage/ezform/drawing/bg/') . $newFileBg);
                            @unlink(Yii::getAlias('@storage/ezform/drawing/') . $fileBg);
                        }
