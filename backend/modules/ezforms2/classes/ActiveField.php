...
class ActiveField extends \yii\widgets\ActiveField
{
	...
	if (!isset($options['item'])) {
		$options['item'] = function ($index, $label, $name, $checked, $value, $other, $showVar, $encode) {
            ...
            $options['item'] = function ($index, $label, $name, $checked, $value, $other, $showVar) {
		$other_input = ((isset($other))?Html::activeTextInput($this->model, $other['attribute'], ['class'=>'form-control']):'') . ((isset($other))?" {$other['suffix']}":'');
		    
                return '<div class="radio">' . Html::radio($name, $checked, ['label' => "<span>$label $other_input $showVar</span>", 'value' => $value]) . '</div>';
            };
        }
