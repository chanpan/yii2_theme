 ...
 */
class TextInputCore extends Object {
...
//	}
	...
	return $view->renderAjax('/widgets/textinput/_view_editor', [
	    'model'=>$model,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/../../ezbuilder/views/widgets/textinput/_view_item', [
	    'field'=>$field,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/widgets/textinput/_options', [
	    'model'=>$model,
	    'input'=>$input,
	]);
    }
