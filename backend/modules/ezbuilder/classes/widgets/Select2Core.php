 ...
 */
class Select2Core extends Object {
...
//	}
	...
	return $view->renderAjax('/widgets/select2/_view_editor', [
	    'model'=>$model,
	    'options'=>$options,
	    'specific'=>$specific,
	    'data'=>$data,
	...
	return $view->renderAjax('/../../ezbuilder/views/widgets/select2/_view_item', [
	    'field'=>$field,
	    'options'=>$options,
	    'specific'=>$specific,
	    'data'=>$data,
	...
	return $view->renderAjax('/widgets/select2/_options', [
	    'model'=>$model,
	    'input'=>$input,
	]);
    }
