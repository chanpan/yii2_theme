...
//	}
	...
	return $view->renderAjax('/widgets/map/_view_editor', [
	    'model'=>$model,
	    'options'=>$options,
	    'specific'=>$specific,
            'data'=>$data,
	...
	return $view->renderAjax('/../../ezbuilder/views/widgets/map/_view_item', [
	    'field'=>$field,
	    'options'=>$options,
	    'specific'=>$specific,
            'data'=>$data,
