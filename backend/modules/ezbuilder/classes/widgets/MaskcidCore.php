 ...
 */
class MaskcidCore extends Object {
...
//	}
	...
	return $view->renderAjax('/widgets/maskcid/_view_editor', [
	    'model'=>$model,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/../../ezbuilder/views/widgets/maskcid/_view_item', [
	    'field'=>$field,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/widgets/maskcid/_options', [
	    'model'=>$model,
	    'input'=>$input,
	]);
    }
