 ...
 */
class AudioCore extends Object {
...
//	}
	...
	return $view->renderAjax('/widgets/audio/_view_editor', [
	    'model'=>$model,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
...
//	}
	...
	return $view->renderAjax('/../../ezbuilder/views/widgets/audio/_view_item', [
	    'field'=>$field,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/widgets/audio/_options', [
	    'model'=>$model,
	    'input'=>$input,
	]);
    }
