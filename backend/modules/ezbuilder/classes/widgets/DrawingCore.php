 ...
 */
class DrawingCore extends Object {
...
//	}
	...
	return $view->renderAjax('/widgets/drawing/_view_editor', [
	    'model'=>$model,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
...
//	}
	...
	return $view->renderAjax('/../../ezbuilder/views/widgets/drawing/_view_item', [
	    'field'=>$field,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/widgets/drawing/_options', [
	    'model'=>$model,
	    'input'=>$input,
	]);
    }
