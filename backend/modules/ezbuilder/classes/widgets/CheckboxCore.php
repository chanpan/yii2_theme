...
/**
 * CheckboxCore class file UTF-8 backend\modules\ezforms2\classes\widgets\CheckboxCore
 ...
 */
class CheckboxCore extends Object {

    /**
     * Initializes this Checkbox.
     */
...
//	}
	...
	return $view->renderAjax('/widgets/checkbox/_view_editor', [
	    'model'=>$model,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/../../ezbuilder/views/widgets/checkbox/_view_item', [
	    'field'=>$field,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/widgets/checkbox/_options', [
	    'model'=>$model,
	    'input'=>$input,
	]);
    }
