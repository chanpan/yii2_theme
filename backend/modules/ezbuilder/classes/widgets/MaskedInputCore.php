...
/**
 * MaskedInputCore class file UTF-8
 ...
 */
class MaskedInputCore extends Object {
...
//	}
	...
	return $view->renderAjax('/widgets/maskedinput/_view_editor', [
	    'model'=>$model,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/../../ezbuilder/views/widgets/maskedinput/_view_item', [
	    'field'=>$field,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/widgets/maskedinput/_options', [
	    'model'=>$model,
	    'input'=>$input,
	]);
    }
