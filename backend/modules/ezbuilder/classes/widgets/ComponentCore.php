...
/**
 * ComponentCore class file UTF-8
 ...
 */
class ComponentCore extends Object {
...
//	}
	...
	return $view->renderAjax('/widgets/component/_view_editor', [
	    'model'=>$model,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/../../ezbuilder/views/widgets/component/_view_item', [
	    'field'=>$field,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/widgets/component/_options', [
	    'model'=>$model,
	    'input'=>$input,
	]);
    }
