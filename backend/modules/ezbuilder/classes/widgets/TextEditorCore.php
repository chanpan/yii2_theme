...
/**
 * TextEditorCore class file UTF-8
 ...
 */
class TextEditorCore extends Object {
	...
	return $view->renderAjax('/widgets/texteditor/_view_editor', [
	    'model'=>$model,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/../../ezbuilder/views/widgets/texteditor/_view_item', [
	    'field'=>$field,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/widgets/texteditor/_options', [
	    'model'=>$model,
	    'input'=>$input,
	]);
    }
