 ...
 */
class CheckboxListCore extends Object {
...
//	}
	...
	return $view->renderAjax('/widgets/checkboxlist/_view_editor', [
	    'model'=>$model,
	    'options'=>$options,
	    'specific'=>$specific,
            'data'=>$data,
	...
	return $view->renderAjax('/../../ezbuilder/views/widgets/checkboxlist/_view_item', [
	    'field'=>$field,
	    'options'=>$options,
	    'specific'=>$specific,
            'data'=>$data,
	...
	return $view->renderAjax('/widgets/checkboxlist/_options', [
	    'model'=>$model,
	    'input'=>$input,
	]);
    }
