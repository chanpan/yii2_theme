 ...
 */
class TargetCore extends Object {
...
//	}
	...
	return $view->renderAjax('/widgets/target/_view_editor', [
	    'model'=>$model,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/../../ezbuilder/views/widgets/target/_view_item', [
	    'field'=>$field,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/widgets/target/_options', [
	    'model'=>$model,
	    'input'=>$input,
	]);
    }
