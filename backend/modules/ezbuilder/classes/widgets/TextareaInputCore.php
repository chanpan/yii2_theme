...
/**
 * TextareaInputCore class file UTF-8
 ...
 */
class TextareaInputCore extends Object {
	...
	return $view->renderAjax('/widgets/textareainput/_view_editor', [
	    'model'=>$model,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/../../ezbuilder/views/widgets/textareainput/_view_item', [
	    'field'=>$field,
	    'options'=>$options,
	    'specific'=>$specific,
	]);
	...
	return $view->renderAjax('/widgets/textareainput/_options', [
	    'model'=>$model,
	    'input'=>$input,
	]);
    }
