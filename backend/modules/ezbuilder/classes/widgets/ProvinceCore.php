 ...
 */
class ProvinceCore extends Object {
...
//	}
	...
	return $view->renderAjax('/widgets/province/_view_editor', [
	    'model'=>$model,
	    'options'=>$options,
	    'specific'=>$specific,
            'data'=>$data,
	...
	return $view->renderAjax('/../../ezbuilder/views/widgets/province/_view_item', [
	    'field'=>$field,
	    'options'=>$options,
	    'specific'=>$specific,
            'data'=>$data,
