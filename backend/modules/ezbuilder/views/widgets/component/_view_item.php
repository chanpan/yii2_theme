...
$template = '{label}<div class="input-group">{input}<span class="input-group-btn">
        <button class="btn btn-default" type="button"><i class="glyphicon glyphicon-cog"></i></button>
      </span>
    </div>{hint}';
...
$pathInput = [
    '{input}'=>  Html::dropDownList($field['ezf_field_name'], $field['ezf_field_default'], [], $options),//Select2::widget($config),//
];
